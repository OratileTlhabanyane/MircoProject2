...
public class SpawningScript : MonoBehaviour
{
    ...
    public float respawnTime = 1f; //this time will tell us how often do we want to spawn the bacteria
    ...
    void Start()
    {
        ...
        StartCoroutine(bacteriaFall());
    }
    private void spawnBacteria ()
    {
        //1. Using Instatiate to load prefab onto the scene
        GameObject b = Instantiate(bacteriaPrefab) as GameObject;
